\documentclass[12pt,UTF8,AutoFakeBold=2,fontset=custom,a4paper]{ctexart}  % 见文件 ctex-fontset-custom.def
...
\usepackage[backend=biber, style=gb7714-2015, maxbibnames=5]{biblatex}
