...
\addbibresource{references/references-settings.bib}
\addbibresource{references/references-crypt.bib}
\addbibresource{references/references-fl.bib}
\addbibresource{references/references-math.bib}
\addbibresource{references/references-med.bib}
\addbibresource{references/references-misc.bib}
\addbibresource{references/references-opt-dl-ml.bib}
\addbibresource{references/references-psp.bib}
...
% \nobibliography*  % https://tex.stackexchange.com/a/195327/163881
...
% https://tex.stackexchange.com/a/91070/163881
...
\newcommand{\doubleuline}[1]{\uline{\uline{#1}}}
...
% https://tex.stackexchange.com/a/60212/163881
...
\setcounter{secnumdepth}{-3} %不让那些section和subsection自带标号，标号格式自己掌握

% \definecolor{blueNSFC}{RGB}{0,112,192} %Ms Word 的蓝色和latex xcolor包预定义的蓝色不一样。通过屏幕取色得到。
